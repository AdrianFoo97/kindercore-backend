...
import { getStudents, createStudent, updateStudent, updateOnboardingProgress, completeOnboarding, withdrawStudent, reactivateStudent, deleteStudent, resetAllStudents } from '../controllers/students.controller.js';
...
studentsRouter.delete('/reset', authMiddleware, asyncHandler(resetAllStudents));
