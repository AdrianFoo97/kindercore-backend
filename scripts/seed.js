...
// ── Lead data ────────────────────────────────────────────────────────────────
// Each lead carries TWO distinct attribution fields:
//   - howDidYouKnow → DISCOVERY source (where parent first heard of us)
//   - utmSource     → SUBMISSION channel (how the enquiry actually
//                     reached us — WhatsApp link, website form, QR,
//                     Facebook lead form). These are decoupled because
//                     a parent who heard of us on Facebook may still
//                     submit through a WhatsApp form link.
// utmSource values mirror the LeadsPage's `legacySubmissionFromUtmSource`
// mapping: 'wa_link' → WhatsApp, 'website' → Website Form, 'qr_card' →
// QR Code, 'fb_form' → Facebook Form. null = submission channel
// unknown (the table will hide the Via badge for these rows).
// enrolled: true → student record auto-created with startDate + onboarding progress
const LEADS = [
  // ══ JANUARY 2026 ══
  { childName: 'Priya Nair',    parentPhone: '0111234001', childDob: dt(2021,9,12),  enrolmentYear: 2026, submittedAt: at(2026,1,6),  status: 'ENROLLED',          appointmentStart: at(2026,1,13), relationship: 'Mother', programme: 'Full day (8:30am–5:30pm)',  addressLocation: 'Bukit Indah',      needsTransport: false, howDidYouKnow: 'Facebook',       ctaSource: 'final',   utmSource: 'wa_link', enrolled: { doneTasks: 3,                     notes: null } },
  { childName: 'Darren Lim',    parentPhone: '0121234002', childDob: dt(2020,4,25),  enrolmentYear: 2026, submittedAt: at(2026,1,8),  status: 'ENROLLED',          appointmentStart: at(2026,1,15), relationship: 'Father', programme: 'Half day (8:30am–2:30pm)', addressLocation: 'Medini',           needsTransport: true,  howDidYouKnow: 'Google',         ctaSource: 'courses', utmSource: 'website', enrolled: { doneTasks: 8,                     notes: null } },
  { childName: 'Lucas Ong',     parentPhone: '0131234003', childDob: dt(2022,11,8),  enrolmentYear: 2026, submittedAt: at(2026,1,10), status: 'ENROLLED',          appointmentStart: at(2026,1,17), relationship: 'Mother', programme: 'Full day (8:30am–5:30pm)',  addressLocation: 'Bukit Indah',      needsTransport: false, howDidYouKnow: 'Word of mouth',  ctaSource: 'final',   utmSource: 'qr_card', enrolled: { doneTasks: 0,                     notes: 'First child, parents need extra support' } },
  { childName: 'Nadia Ismail',  parentPhone: '0141234004', childDob: dt(2020,10,5),  enrolmentYear: 2026, submittedAt: at(2026,1,13), status: 'ENROLLED',          appointmentStart: at(2026,1,20), relationship: 'Mother', programme: 'Full day (8:30am–5:30pm)',  addressLocation: 'Nusajaya',         needsTransport: true,  howDidYouKnow: 'Word of mouth',  ctaSource: 'courses', utmSource: null,      enrolled: { doneTasks: ONBOARDING_TASKS.length, notes: 'Sibling discount applied' } },
  { childName: 'Wei Jie Tan',   parentPhone: '0151234005', childDob: dt(2020,1,30),  enrolmentYear: 2026, submittedAt: at(2026,1,16), status: 'FOLLOW_UP',         appointmentStart: at(2026,1,23), relationship: 'Father', programme: 'Half day (8:30am–2:30pm)', addressLocation: 'Bukit Indah',      needsTransport: false, howDidYouKnow: 'Google',         ctaSource: 'methods', utmSource: 'website', notes: 'Visited, parent considering options' },
  { childName: 'Fatimah Zahra', parentPhone: '0161234006', childDob: dt(2022,7,22),  enrolmentYear: 2026, submittedAt: at(2026,1,19), status: 'FOLLOW_UP',         appointmentStart: at(2026,1,26), relationship: 'Mother', programme: 'Basic (8:30am–12:30pm)',   addressLocation: 'Iskandar Puteri',  needsTransport: false, howDidYouKnow: 'Instagram',      ctaSource: 'story',   utmSource: 'wa_link', notes: 'Called after visit, still undecided' },
  { childName: 'Harish Kumar',  parentPhone: '0171234007', childDob: dt(2021,3,14),  enrolmentYear: 2026, submittedAt: at(2026,1,22), status: 'LOST',              lostReason: 'Enrolled in another school', relationship: 'Father', programme: 'Full day (8:30am–5:30pm)', addressLocation: 'Permas Jaya', needsTransport: true, howDidYouKnow: 'Facebook', ctaSource: 'hero', utmSource: 'fb_form' },
  { childName: 'Kavitha Raj',   parentPhone: '0181234008', childDob: dt(2021,6,17),  enrolmentYear: 2027, submittedAt: at(2026,1,27), status: 'APPOINTMENT_BOOKED', appointmentStart: at(2026,4,7),  relationship: 'Mother', programme: 'Full day (8:30am–5:30pm)',  addressLocation: 'Bukit Indah',      needsTransport: false, howDidYouKnow: 'Facebook',       ctaSource: 'final',   utmSource: 'wa_link' },
  // ══ FEBRUARY 2026 ══
  { childName: 'Nurul Aina',    parentPhone: '0191234009', childDob: dt(2022,8,20),  enrolmentYear: 2026, submittedAt: at(2026,2,3),  status: 'FOLLOW_UP',         appointmentStart: at(2026,2,10), relationship: 'Mother', programme: 'Half day (8:30am–2:30pm)', addressLocation: 'Bukit Indah',      needsTransport: false, howDidYouKnow: 'Facebook',       ctaSource: 'courses', utmSource: 'wa_link', notes: 'Visited, waiting for spouse confirmation' },
  { childName: 'Siti Rahmah',   parentPhone: '0111234010', childDob: dt(2021,12,3),  enrolmentYear: 2026, submittedAt: at(2026,2,6),  status: 'CONTACTED',         appointmentStart: at(2026,4,14), appointmentIsPlaceholder: true, relationship: 'Mother', programme: 'Full day (8:30am–5:30pm)', addressLocation: 'Medini', needsTransport: true, howDidYouKnow: 'Google', ctaSource: 'methods', utmSource: 'website', notes: 'Replied via WhatsApp, placeholder scheduled' },
  { childName: 'Danish Hakim',  parentPhone: '0121234011', childDob: dt(2020,7,16),  enrolmentYear: 2026, submittedAt: at(2026,2,10), status: 'APPOINTMENT_BOOKED', appointmentStart: at(2026,4,9),  relationship: 'Father', programme: 'Half day (8:30am–2:30pm)', addressLocation: 'Bukit Indah',      needsTransport: false, howDidYouKnow: 'Instagram',      ctaSource: 'final',   utmSource: 'wa_link' },
  { childName: 'Aryan Singh',   parentPhone: '0131234012', childDob: dt(2019,11,28), enrolmentYear: 2026, submittedAt: at(2026,2,13), status: 'CONTACTED',         appointmentStart: at(2026,4,16), appointmentIsPlaceholder: true, relationship: 'Father', programme: 'Full day (8:30am–5:30pm)', addressLocation: 'Bukit Indah', needsTransport: false, howDidYouKnow: 'Google', ctaSource: 'story', utmSource: 'website' },
  { childName: 'Jasmine Lee',   parentPhone: '0141234013', childDob: dt(2021,5,9),   enrolmentYear: 2026, submittedAt: at(2026,2,17), status: 'FOLLOW_UP',         appointmentStart: at(2026,2,24), relationship: 'Mother', programme: 'Full day (8:30am–5:30pm)',  addressLocation: 'Permas Jaya',      needsTransport: true,  howDidYouKnow: 'Facebook',       ctaSource: 'courses', utmSource: 'wa_link', notes: 'Interested in full day, price is a concern' },
  { childName: 'Zulkifli Ahmad',parentPhone: '0151234014', childDob: dt(2020,9,14),  enrolmentYear: 2026, submittedAt: at(2026,2,19), status: 'LOST',              lostReason: 'Fee too expensive', relationship: 'Father', programme: 'Half day (8:30am–2:30pm)', addressLocation: 'Bukit Indah', needsTransport: false, howDidYouKnow: 'Word of mouth', ctaSource: 'hero', utmSource: null },
  { childName: 'Alicia Tan',    parentPhone: '0161234015', childDob: dt(2022,4,27),  enrolmentYear: 2027, submittedAt: at(2026,2,22), status: 'NEW',               relationship: 'Mother', programme: 'Basic (8:30am–12:30pm)',   addressLocation: 'Medini',           needsTransport: false, howDidYouKnow: 'Flyer / Banner', ctaSource: 'hero',    utmSource: 'qr_card' },
  { childName: 'Emma Chong',    parentPhone: '0171234016', childDob: dt(2023,2,11),  enrolmentYear: 2027, submittedAt: at(2026,2,25), status: 'NEW',               relationship: 'Mother', programme: 'Full day (8:30am–5:30pm)',  addressLocation: 'Skudai',           needsTransport: true,  howDidYouKnow: 'Word of mouth',  ctaSource: 'story',   utmSource: 'qr_card' },
  // ══ MARCH 2026 ══
  { childName: 'Amir Haziq',    parentPhone: '0181234017', childDob: dt(2022,12,10), enrolmentYear: 2026, submittedAt: at(2026,3,3),  status: 'NEW',               relationship: 'Father', programme: 'Half day (8:30am–2:30pm)', addressLocation: 'Bukit Indah',      needsTransport: false, howDidYouKnow: 'Facebook',       ctaSource: 'final',   utmSource: 'fb_form' },
  { childName: 'Izzatul Husna', parentPhone: '0191234018', childDob: dt(2021,8,3),   enrolmentYear: 2026, submittedAt: at(2026,3,5),  status: 'CONTACTED',         appointmentStart: at(2026,4,21), appointmentIsPlaceholder: true, relationship: 'Mother', programme: 'Full day (8:30am–5:30pm)', addressLocation: 'Iskandar Puteri', needsTransport: false, howDidYouKnow: 'Google', ctaSource: 'courses', utmSource: 'website' },
  { childName: 'Mei Ling Cheah',parentPhone: '0111234019', childDob: dt(2020,5,19),  enrolmentYear: 2026, submittedAt: at(2026,3,7),  status: 'NEW',               relationship: 'Mother', programme: 'Half day (8:30am–2:30pm)', addressLocation: 'Bukit Indah',      needsTransport: false, howDidYouKnow: 'Facebook',       ctaSource: 'methods', utmSource: 'wa_link' },
  { childName: 'Farhan Aziz',   parentPhone: '0121234020', childDob: dt(2021,10,7),  enrolmentYear: 2026, submittedAt: at(2026,3,9),  status: 'APPOINTMENT_BOOKED', appointmentStart: at(2026,4,24), relationship: 'Father', programme: 'Full day (8:30am–5:30pm)', addressLocation: 'Medini', needsTransport: true, howDidYouKnow: 'Word of mouth', ctaSource: 'final', utmSource: null },
  { childName: 'Sofia Yusof',   parentPhone: '0131234021', childDob: dt(2020,3,22),  enrolmentYear: 2027, submittedAt: at(2026,3,11), status: 'NEW',               relationship: 'Mother', programme: 'Half day (8:30am–2:30pm)', addressLocation: 'Nusajaya',         needsTransport: false, howDidYouKnow: 'Google',         ctaSource: 'story',   utmSource: 'website' },
  { childName: 'Husni Yusof',   parentPhone: '0141234022', childDob: dt(2019,6,14),  enrolmentYear: 2026, submittedAt: at(2026,3,13), status: 'NEW',               relationship: 'Father', programme: 'Basic (8:30am–12:30pm)',   addressLocation: 'Bukit Indah',      needsTransport: false, howDidYouKnow: 'Flyer / Banner', ctaSource: 'hero',    utmSource: 'qr_card' },
  { childName: 'Syafiq Razali', parentPhone: '0151234023', childDob: dt(2021,7,31),  enrolmentYear: 2026, submittedAt: at(2026,3,15), status: 'NEW',               relationship: 'Father', programme: 'Full day (8:30am–5:30pm)',  addressLocation: 'Permas Jaya',      needsTransport: true,  howDidYouKnow: 'Facebook',       ctaSource: 'methods', utmSource: 'wa_link' },
  { childName: 'Erica Lim',     parentPhone: '0161234024', childDob: dt(2023,1,25),  enrolmentYear: 2027, submittedAt: at(2026,3,17), status: 'NEW',               relationship: 'Mother', programme: 'Full day (8:30am–5:30pm)',  addressLocation: 'Bukit Indah',      needsTransport: false, howDidYouKnow: 'Instagram',      ctaSource: 'courses', utmSource: 'wa_link' },
  { childName: 'Tan Wei Xuan',  parentPhone: '0171234025', childDob: dt(2022,5,16),  enrolmentYear: 2026, submittedAt: at(2026,3,8), status: 'NEW',                relationship: 'Mother', programme: 'Half day (8:30am–2:30pm)', addressLocation: 'Medini',           needsTransport: false, howDidYouKnow: 'Word of mouth',  ctaSource: 'final',   utmSource: 'qr_card' },
];
    ...
    await conn.execute(
      `INSERT INTO \`Lead\`
         (id, submittedAt, childName, parentPhone, childDob, enrolmentYear, status, notes,
          ...
          relationship, programme, addressLocation, needsTransport, howDidYouKnow, ctaSource, utmSource)
       VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)`,
      [
        leadId,
        lead.submittedAt,
